...
<title>Aqua.Party(아쿠아 파티) Agar.io</title>
...
<h2 style="font-family:'Orbitron',sans-serif;font-size:13px;color:white" id="titleh">익스플로러 전용 무한분열 바로가기 버튼 </h2>
<a href="./c" target="_blank"style="background-color: orange" id="cafe-btn" class="btn btn-default btn-sm" role="button">무한분열</a>
</br>
</center>
</div>
